...
B<#ifdef __cplusplus>E<10> E<8>B<std::complexE<lt>doubleE<gt> cerf (std::complexE<lt>doubleE<gt> z );>E<10> E<8>B<#endif>

B<double _Complex cerfc ( double _Complex z );>

B<#ifdef __cplusplus>E<10> E<8>B<std::complexE<lt>doubleE<gt> cerfc (std::complexE<lt>doubleE<gt> z );>E<10> E<8>B<#endif>
