...
The computation of D(z) is based on Faddeeva's function B<w_of_z>; to compute D(x), the imaginary part B<im_w_of_x> is used.
...
B<w_of_z(3)>, B<voigt(3)>, B<cerf(3)>, B<erfcx(3)>, B<erfi(3)>.
